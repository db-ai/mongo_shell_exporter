...
Registry.createMetric(require('src/metrics/wt/cursor/wt_cursor_calls.json'))
...
Registry.createMetric(require('src/metrics/wt/cursor/wt_cursor_updated_key_value_bytes.json'))
