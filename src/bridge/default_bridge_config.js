import EachKeyAsLabeledMetric from 'src/rules/each_key_as_labeled_metric'
import EachKeyAsLabeledMetricWithSuffix from 'src/rules/each_key_as_labeled_metric_with_suffix.js'
import Ignore from 'src/rules/ignore.js'
import PathsAsSingleMetricWithLabels from 'src/rules/paths_as_signle_metric_with_labels.js'
import Read from 'src/rules/read.js'
import ReadHistogram from 'src/rules/read_histogram.js'
import RemapKeysAsMetrics from 'src/rules/remap_keys.js'
